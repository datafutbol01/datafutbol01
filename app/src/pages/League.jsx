      ...
      <AnimatePresence mode="wait">
        {activeTab === 'actualidad' && (
          ...
          >
              ...
              <div style={{ display: 'flex', flexDirection: ['libertadores', 'sudamericana', 'eng_league_one', 'eng_league_two', 'arg_nacional_b', 'arg_b_metro', 'arg_primera_c'].includes(leagueId) ? 'column-reverse' : 'column', gap: '2rem' }}>
