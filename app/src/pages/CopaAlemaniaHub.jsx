...
export default function CopaAlemaniaHub() {
    const seasons = [
        { year: 2026, host: 'Alemania' }
    ];
    ...
    useEffect(() => {
        ...
        let importPromise;
        switch (selectedYear) {
            case 2026: importPromise = import('../data/copas/alemania/2026.json'); break;
        ...
        <div style={{ minHeight: '100vh', background: 'var(--bg-main)', position: 'relative' }}>
                    ...
                    <div style={{
                        ...
                        <motion.img
                            ...
                            style={{
                                ...
                                filter: 'contrast(1.2) saturate(1.3) brightness(0.6) sepia(20%) hue-rotate(330deg)', // Un toque rojizo para alemania
            ...
            <div style={{ textAlign: 'center', marginBottom: '2rem', padding: '0 2rem' }}>
                ...
                <p style={{ color: 'var(--text-muted)', fontSize: '1.2rem', maxWidth: '800px', margin: '0 auto', fontWeight: '300' }}>
                    Revive la DFB Pokal alemana. Repasa las llaves eliminatorias y las estadísticas históricas de la copa.
                </p>
            </div>
                    ...
                    {selectedYear === null ? (
                        ...
                        >
                            ...
                            <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '1.2rem', maxWidth: '600px', margin: '0 auto 3rem', lineHeight: '1.6' }}>
                                Selecciona un año en el carrusel superior para revivir cada partido de la DFB Pokal.
                            </p>
                        </motion.div>
                    ) : (
                        <motion.div
