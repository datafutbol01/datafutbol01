...
// Use an external python script to do the massive requesting to prevent node.js fetch limitations
// The python script will use a robust approach
const pythonScript = `
...
`
fs.writeFileSync('fetch_ogol.py', pythonScript);
console.log('Python script prepared.');
