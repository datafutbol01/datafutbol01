...
// Reorder bracket so UI lines match perfectly
data.bracket = {
  roundOf16: [
    // Para QF0 (Italia vs España)
    ...
    // Para QF3 (Paises Bajos vs Brasil)
...
console.log("Llave final reordenada paramétricamente para el UI.");
