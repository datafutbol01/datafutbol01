...
function toSlug(name) {
    ...
    if(n === 'middlesbrough') return 'middlesbrough';
...
function processFolders() {
    ...
    for(const f of folders) {
        if(f.toLowerCase() <= 'girona') continue; // Already processed
        if(f.toLowerCase() > 'middlesbrough') continue; // Stop at Middlesbrough
